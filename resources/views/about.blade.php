<x-layouts-main>
    <x-slot name="meta">
        ...
        <link rel="canonical" href="https://francescomansi.me/chi-sono"/>
        ...
        <meta property="og:description" content="Ciao sono Francesco Mansi, vivo e lavoro in Puglia, precisamente a Monopoli. Sono un Freelance e attualmente collaboro con Aziende, Associazioni e Privati. Mi occupo principalmente di consulenza digitale, sviluppo web e formazione." />
        ...
        <meta name="twitter:description" content="Ciao sono Francesco Mansi, vivo e lavoro in Puglia, precisamente a Monopoli. Sono un Freelance e attualmente collaboro con Aziende, Associazioni e Privati. Mi occupo principalmente di consulenza digitale, sviluppo web e formazione." />
        <meta name="twitter:image" content="https://francescomansi.me/img/francesco-mansi-web.jpg" />

        <title>Chi Sono | Francesco Mansi - Web Developer e Web Designer</title>
        <meta name="description" content="Ciao sono Francesco Mansi, vivo e lavoro in Puglia, precisamente a Monopoli. Sono un Freelance e attualmente collaboro con Aziende, Associazioni e Privati. Mi occupo principalmente di consulenza digitale, sviluppo web e formazione.">
        ...
        <script type="application/ld+json">
            ...
            "gender": "Male",
            "Description": "Ciao sono Francesco Mansi, vivo e lavoro in Puglia, precisamente a Monopoli. Sono un Freelance e attualmente collaboro con Aziende, Associazioni e Privati. Mi occupo principalmente di consulenza digitale, sviluppo web e formazione.",
    ...
    <div class="relative w-full py-20 pb-20 overflow-hidden bg-white md:pb-64">
          <div class="container relative flex flex-col justify-between h-full max-w-6xl px-8 mx-auto xl:px-0">
              <div class="flex-auto max-w-4xl prose">
                   <span class="text-3xl sm:text-4xl font-extrabold text-black tracking-tight">— Chi sono</span>
                  <h1 class="hidden">Mi chiamo Francesco Mansi e sono un Web developer e Web Designer a Monopoli.</h1>

                  <p class="mt-4 text-lg text-black">
                      Ciao mi chiamo Francesco, vivo e lavoro in Puglia, precisamente a Monopoli.<br>
                      Sono un Freelance e attualmente collaboro con Aziende, Associazioni e Privati. <br>
                      Mi occupo principalmente di <strong>consulenza digitale</strong>, <strong>sviluppo web</strong> e <strong>formazione</strong>.
                  </p>
                  <p class="mb-2 text-sm leading-6 font-semibold text-gray-800">Consulenza Digitale</p>
                  <div class="mt-4 text-lg text-black">
                      <ul>
                          <li>Collaboro come partner digitale di una Associazione di Promozione Sociale – <span class="italic">con sede a Cerignola</span>.</li>                       </li>
                          <li>Collaboro come partner digitale di una Associazione Sportiva Dilettantistica – <span class="italic">con sede a Locorotondo</span>.</li>
                          <li>Collaboro come partner digitale di una Associazione Culturale – <span class="italic">con sede a Barletta</span>.</li>
                    </ul>
                  </div>
                  <p class="mb-2 text-sm leading-6 font-semibold text-gray-800">Sviluppo Web</p>
                  <p class="mt-4 text-lg text-black">
                      Lavoro per Privati e Aziende su base oraria. <br>Dal semplice task fino ad arrivare al progetto completo, in cui mi avvalgo della collaborazione di altri professionisti in ambito grafico, SEO e marketing.
                  </p>
                  <p class="mb-2 text-sm leading-6 font-semibold text-gray-800">Formazione</p>
                  <p class="mt-4 text-lg text-black">
                      Mi occupo di formazione in ambito web con Corsi base individuali a professionisti e studenti.<br>
                      Dal semplice web design con HTML,CSS e Javascript a corsi piu avanzati con il Framework Laravel.<br>
                      Inoltre sono autore dell'ebook "Laravel Per tutti - Versione 8" e del "Tips and Tricks" sul subreddit <span class="italic">r/PHP </span>.
                  </p>
                  <p class="mb-2 text-sm leading-6 font-semibold text-gray-800">Social</p>
                  <p class="mt-4 text-lg text-black">
                      <a href="https://www.linkedin.com/in/francesco-mansi/">Linkedin</a> | <a href="https://github.com/framansi" target="_blank">Github</a> | <a href="https://codepen.io/framansi" target="_blank">Codepen </a>|&nbsp;<a href="https://leanpub.com/u/framansi" target="_blank" >Leanpub</a>
                  </p>
              </div>

                  <div class="py-12 mx-auto">
                       <div class="relative flex items-center self-start inline-block w-auto mt-20 text-4xl font-black">
                          <span class="relative">— Collaborazioni</span>
                      </div>
                      <p class="text-lg font-medium text-gray-500 sm:text-2xl">Aziende, Associazioni, Enti Pubblici, Privati e Web Agency in cui ho lavorato e/o collaboro ancora oggi.</p>
                      <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5 mt-5">

                          <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
                              <svg  class="h-12 text-gray-500 fill-current" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    viewBox="0 0 46 45" style="enable-background:new 0 0 46 45;" xml:space="preserve">
                                <style type="text/css">
                                    .st100{fill:#FFFFFF;}
                                </style>
                                  <g id="Group">
                                      <path id="Rectangle-5" d="M0,0h46v18.8V45H0V0z"/>
                                  </g>
                                  <polygon class="st100" points="9.8,4.8 9.8,15.6 10,15.6 18.5,4.8 23,4.8 23,22.5 18.5,22.5 18.5,11.6 18.2,11.6 9.8,22.5 5.3,22.5
                            5.3,4.8 "/>
                                  <polygon class="st100" points="29.6,12.2 35.2,4.8 40.7,4.8 33.8,13.2 41.5,22.5 35.4,22.5 29.6,14.8 29.6,14.8 29.6,22.5 24.9,22.5
                            24.9,4.8 29.6,4.8 "/>
                                  <polygon class="st100" points="9.8,40.1 9.8,29.3 10,29.3 18.5,40.1 23,40.1 23,22.4 18.5,22.4 18.5,33.3 18.2,33.3 9.8,22.4
                            5.3,22.4 5.3,40.1 "/>
                                  <polygon class="st100" points="29.6,33 35.2,40.1 40.7,40.1 33.8,31.7 41.5,22.4 35.4,22.4 29.6,30.1 29.6,30.1 29.6,22.4 24.9,22.4
                            24.9,40.1 29.6,40.1 "/>
                    </svg>
                          </div>
                          <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
                              <svg class="h-10 text-gray-500 fill-current" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                          ...
                          <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
                              <img src="/img/loghi/puglia.svg" class="h-10 text-gray-500 fill-current" alt="Logo regione Puglia">

                          </div>
                          <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
                            <img src="/img/loghi/adecco.png" class="h-10 text-gray-500 fill-current" alt="Logo Adecco">
            ...
            <div class="relative flex items-center self-start inline-block w-auto mt-20 text-4xl font-black">
                 <span class="relative">— Stack List</span>
            </div>
              <h2 class="mt-4 text-lg text-black py-5">
                  In maniera altrettanto sintetica, ecco il mio stack di sviluppo principale che utilizzo per la Realizzazione siti web, creazione siti web e-commerce e software gestionali.<br>
              </h2>
            <div class="flex w-full h-full">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5" >
                        ...
                        <div class="w-full mb-10 sm:mb-0">
                            <div class="relative ml-0 mr-0 sm:mr-10">
                                ...
                                <div class="relative p-5 bg-white border-2 border-gray-500 rounded-lg h-44">
                                    <div class="flex items-center -mt-1">
                                        <svg class="w-8 h-8 text-orange-500 fill-current" fill="none" height="2500" width="2183" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 124 141.53"><path d="M10.383 126.892L0 0l124 .255-10.979 126.637-50.553 14.638z" fill="#1b73ba"/><path d="M62.468 129.275V12.085l51.064.17-9.106 104.85z" fill="#1c88c7"/><path d="M100.851 27.064H22.298l2.128 15.318h37.276l-36.68 15.745 2.127 14.808h54.043l-1.958 20.68-18.298 3.575-16.595-4.255-1.277-11.745H27.83l2.042 24.426 32.681 9.106 31.32-9.957 4-47.745H64.765l36.085-14.978z" fill="#fff"/></svg>
                                         <h3 class="my-2 ml-3 text-lg font-bold text-gray-800">CSS</h3>
                                    </div>
                                    <p class="mb-2 text-gray-600">Conoscenza approfondita del CSS e utilizzo con e senza preprocessore SCSS.</p>
                                </div>
                            ...
                            <div class="relative ml-0 mr-0 sm:mr-10">
                                ...
                                <div class="relative p-5 bg-white border-2 border-gray-500 rounded-lg h-44">
                                    <div class="flex items-center -mt-1">
                                        ...
                                        <svg class="w-8 h-8 text-orange-500 fill-current" xmlns="http://www.w3.org/2000/svg" width="2500" height="2500" viewBox="0 0 1052 1052"><path fill="#f0db4f" d="M0 0h1052v1052H0z"/><path d="M965.9 801.1c-7.7-48-39-88.3-131.7-125.9-32.2-14.8-68.1-25.399-78.8-49.8-3.8-14.2-4.3-22.2-1.9-30.8 6.9-27.9 40.2-36.6 66.6-28.6 17 5.7 33.1 18.801 42.8 39.7 45.4-29.399 45.3-29.2 77-49.399-11.6-18-17.8-26.301-25.4-34-27.3-30.5-64.5-46.2-124-45-10.3 1.3-20.699 2.699-31 4-29.699 7.5-58 23.1-74.6 44-49.8 56.5-35.6 155.399 25 196.1 59.7 44.8 147.4 55 158.6 96.9 10.9 51.3-37.699 67.899-86 62-35.6-7.4-55.399-25.5-76.8-58.4-39.399 22.8-39.399 22.8-79.899 46.1 9.6 21 19.699 30.5 35.8 48.7 76.2 77.3 266.899 73.5 301.1-43.5 1.399-4.001 10.6-30.801 3.199-72.101zm-394-317.6h-98.4c0 85-.399 169.4-.399 254.4 0 54.1 2.8 103.7-6 118.9-14.4 29.899-51.7 26.2-68.7 20.399-17.3-8.5-26.1-20.6-36.3-37.699-2.8-4.9-4.9-8.7-5.601-9-26.699 16.3-53.3 32.699-80 49 13.301 27.3 32.9 51 58 66.399 37.5 22.5 87.9 29.4 140.601 17.3 34.3-10 63.899-30.699 79.399-62.199 22.4-41.3 17.6-91.3 17.4-146.6.5-90.2 0-180.4 0-270.9z" fill="#323330"/></svg>
                                        <h3 class="my-2 ml-3 text-lg font-bold text-gray-800">Javascript</h3>
                                    </div>
                                     <p class="mb-2 text-gray-600">Solide basi di Javascript maturate nel corso degli anni di lavoro e con il corso Universitario. </p>
                                </div>
                            ...
                            <div class="relative ml-0 mr-0 sm:mr-10">
                                ...
                                <div class="relative p-5 bg-white border-2 border-gray-500 rounded-lg h-44">
                                    <div class="flex items-center -mt-1">
                                        ...
                                        <svg class="w-8 h-8 text-orange-500 fill-current" fill="none" height="2500" viewBox="1.069 54 198.26 91.221" width="2500" xmlns="http://www.w3.org/2000/svg"><g clip-rule="evenodd" fill-rule="evenodd"><path d="m155.271 54 44.058 44.002-44.058 44.001-44.057-44.001z" fill="#77c1d2"/><path d="m45.127 54 91.337 91.221h-88.115l-47.28-47.22z" fill="#2d3441"/></g></svg>
                                        <h3 class="my-2 ml-3 text-lg font-bold text-gray-800">Alpine JS</h3>
                                    </div>
                                    <p class="mb-2 text-gray-600">Ideale per progetti personali o gestionali che non richiedono particolari requisiti vista la sua leggerezza e potenza.</p>
                                </div>
                ...
                <div class="flex justify-center mt-10 ">
                    <a href="{{route('contact')}}" class="relative inline-block px-10 py-3 font-medium group my-4">
                        ...
                        <span class="relative text-black text-base xl:text-xl font-bold group-hover:text-white">Chiedi una Consulenza </span>
                    </a>
